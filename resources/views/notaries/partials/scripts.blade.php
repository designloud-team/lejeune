    ...
    $('#btn-apply').on('click', function (e) {
        ...
        if (rows_selected.length == 0) {
            ...
            swal({
                ...
                title: "Are you sure?",
                text: rows_selected.length + " notaries will be deleted permanently from this system!",
                type: "warning",
                ...
                $.ajax({
                    url: "{{route('notaries.destroy-all') }}",
                    data: {
                        notaries: rows_selected // will be accessible in $_POST['data1']
                    },
