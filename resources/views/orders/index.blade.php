        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                <form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 20px;"
                      action="{{ URL::to('orders/importExcel') }}" class="form-horizontal" method="post"
            ...
            <div class="box box-default">
                <div class="box-body">
                    ...
                    <div class="responsive-tables">
                        <table class="table table-bordered display responsive tbl-orders" width="100%">
                            <thead>
                            <tr>
                                <th></th>
                                <th>Order ID</th>
