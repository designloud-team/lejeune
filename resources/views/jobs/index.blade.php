        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                <form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 20px;"
                      action="{{ URL::to('jobs/importExcel') }}" class="form-horizontal" method="post"
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="pull-right">
                <div class="btn-group">
                    <a href="/jobs/create" class="btn btn-danger">Add Job</a>
            ...
            <div class="box box-default">
                <div class="box-body">
                    ...
                    <div class="responsive-tables">
                        <table class="table table-bordered display responsive tbl-jobs" width="100%">
                            <thead>
                            <tr>
                                <th></th>
                                <th>ID</th>
